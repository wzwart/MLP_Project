...
class UNet_symmetric(nn.Module):
    ...
    def __init__(self, in_channel, out_channel):
        super(UNet_symmetric, self).__init__()
        # Encode
    ...
    def build_module(self, in_channel, out_channel):
        ...
        # Decode
        self.conv_decode3 = self.expansive_block(1024, 512, 256)
    ...
    def forward(self, x):
        ...
        # Decode
        decode_block3 = self.crop_and_concat(bottleneck1, encode_block2, crop=False)
        cat_layer2 = self.conv_decode3(decode_block3)
        decode_block2 = self.crop_and_concat(cat_layer2, encode_block1, crop=False)
