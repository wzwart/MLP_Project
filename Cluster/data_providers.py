...
class FacesDataProvider(DataProvider):
    ...
    def __init__(self, which_set='train',
        ...
        transformed_dataset = FacialKeypointsDataset(csv_file=os.path.join(filepath_to_data ,'{0}_frames_keypoints.csv'.format(internal_name[which_set])),
        ...
        super(FacesDataProvider, self).__init__(
